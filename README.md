...
> A TypeScript API communication library for commonly used network hardware and
> tools
...
**SubDriver Architecture**: Version 0.5.0 introduces a new SubDriver
architecture that changes how you access driver methods. The last version
supporting the old implementation is **0.4.x**.
...
- Access methods through resource-specific sub-drivers (e.g., `netbox.prefixes`,
  `netbox.devices`, `netbox.vlans`)
...
- 🔧 **[VMware NSX Driver](src/core/hw/vmware/README.md)** - Software-defined
  networking
- ⚖️ **[VMware AVI Driver](src/core/hw/vmware/avi/README.md)** - NSX Advanced
  Load Balancer management
- 🌐 **[NAM v2 Driver](src/core/tools/nhn/nam-v2/README.md)** - Network
  architecture management
- 🔄 **[ROR v1 Driver](src/core/tools/nhn/ror-v1/README.md)** - Resource
  orchestration and registry

### Utilities

- ⚙️ **[EnvLoader](src/core/utils/README.md)** - Configuration and secrets
  management

### Logging

- 📊 **[Winston HEC Logger](src/core/loggers/README.md)** - Splunk HTTP Event
  Collector transport

### Testing & Examples

- 📝 **[Test Suite Documentation](test/README.md)** - Unit tests, integration
  tests, and examples
- 🎮 **[Playground](playground/README.md)** - Manual testing and driver
  verification

## Development

See [Development Guide](DEVELOPMENT.md) for building, testing, project
